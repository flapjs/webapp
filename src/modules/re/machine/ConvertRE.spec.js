...
import {RegularExpression, UNION, KLEENE} from './RegularExpression.js';
...
function containsArray(array, subarray) 
{
    ...
    // hash.hasOwnProperty(subarray);
    return subarray in hash;
}
...
describe('Converting RE - "a": ', () => 
{
    ...
    let regex = RegularExpression.parse('a');
    testConvertRE(convertToNFA(regex), machine, true);

    regex = RegularExpression.parse('(a)');
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "a ' + UNION + ' b"', () => 
{
    ...
    let regex = RegularExpression.parse('a' + UNION + 'b');
    testConvertRE(convertToNFA(regex), machine, true);

    regex = RegularExpression.parse('(a' + UNION + 'b)');
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "ab"', () => 
{
    ...
    let regex = RegularExpression.parse('ab');
    testConvertRE(convertToNFA(regex), machine, true);

    regex = RegularExpression.parse('(ab)');
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "a' + KLEENE + '"', () => 
{
    ...
    let regex = RegularExpression.parse('a' + KLEENE);
    testConvertRE(convertToNFA(regex), machine, true);

    regex = RegularExpression.parse('(a' + KLEENE + ')');
    testConvertRE(convertToNFA(regex), machine, true);
...
describe('Converting RE - "abc"', () => 
{
    ...
    let regex = RegularExpression.parse('abc');
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "a' + UNION + 'b' + UNION + 'c"', () => 
{
    ...
    let regex = RegularExpression.parse('a' + UNION + 'b' + UNION + 'c');
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "ab' + UNION + 'c" and "a' + UNION + 'bc"', () => 
{
    ...
    let regex = RegularExpression.parse('ab' + UNION + 'c');
    testConvertRE(convertToNFA(regex), machine, true);
    ...
    regex = RegularExpression.parse('a' + UNION + 'bc');
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "a' + UNION + 'b' + KLEENE + '" and "(a' + UNION + 'b)' + KLEENE + '"', () => 
{
    ...
    let regex = RegularExpression.parse('a' + UNION + 'b' + KLEENE);
    testConvertRE(convertToNFA(regex), machine, true);
    ...
    regex = RegularExpression.parse('(a' + UNION + 'b)' + KLEENE);
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "ab' + KLEENE + '" and "(ab)' + KLEENE + '"', () => 
{
    ...
    let regex = RegularExpression.parse('ab' + KLEENE);
    testConvertRE(convertToNFA(regex), machine, true);
    ...
    regex = RegularExpression.parse('(ab)' + KLEENE);
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "(a' + UNION + 'bc)' + KLEENE + '"', () => 
{
    ...
    let regex = RegularExpression.parse('(a' + UNION + 'bc)' + KLEENE);
    testConvertRE(convertToNFA(regex), machine, true);
});
...
describe('Converting RE - "(ab' + UNION + '(a' + UNION + 'bc)' + KLEENE + 'c' + KLEENE + ')' + KLEENE + '"', () => 
{
    ...
    let regex = RegularExpression.parse('(ab' + UNION + '(a' + UNION + 'bc)' + KLEENE + 'c' + KLEENE + ')' + KLEENE);
    testConvertRE(convertToNFA(regex), machine, true);
});
