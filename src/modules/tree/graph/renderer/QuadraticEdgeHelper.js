 ...
 * @param {ReadonlyPosition} from The from point of the edge.
 * @param {ReadonlyPosition} to The to point of the edge.
...
/**
 * @typedef {Readonly<Object>} ReadonlyPosition
 * @property {Number} x
 * @property {Number} y
 * 
...
/**
 * 
 * @param {ReadonlyPosition} point 
 * @param {ReadonlyPosition} from 
 * @param {ReadonlyPosition} to 
 * @param {Object} opts 
 * @param {Object} dst 
 */
