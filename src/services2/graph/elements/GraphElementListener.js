 ...
 * @description
 * You may notice that if you use useContext(GraphStateContext), sometimes changes on the
 * graph don't propagate. That is intentional. Use this to listen for "minute" changes
 * in the graph elements that don't incur a re-render. That's why we FORBID using GraphStateContext
 * this way.
 * 
